...
const mobileRenderers = {
  ...
  h1({ children }) {
    return (
      <h1 className="text-[28px] font-bold text-white mt-12 mb-6 pb-6 border-b border-zinc-800/80 leading-tight">
        {children}
      </h1>
    );
  },
  ...
  h2({ children }) {
    return (
      <h2 className="sticky top-[60px] z-30 bg-zinc-950/95 backdrop-blur-xl py-5 text-[22px] font-bold text-white mt-14 mb-6 flex items-center gap-3 border-b border-zinc-800/60 -mx-6 px-6 shadow-sm">
  ...
  h3({ children }) {
    return (
      <h3 className="text-base font-bold text-rose-400 mt-8 mb-3 uppercase tracking-widest">
        {children}
      </h3>
    );
  },
  ...
  return (
    <div className="w-full bg-zinc-950 pb-8">
      ...
      <div className="sticky top-0 z-40 bg-zinc-950/80 backdrop-blur-2xl border-b border-zinc-800/50 px-4 py-3 flex items-center justify-between pt-safe-top h-[60px]">
        ...
        <div className="px-4 py-1.5 rounded-full bg-rose-500/15 border border-rose-500/30 text-rose-400 text-[13px] font-data font-bold tracking-wider shadow-[0_0_15px_rgba(244,63,94,0.15)]">
          {ticker}
        </div>
